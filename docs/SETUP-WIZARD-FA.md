# 🧙‍♂️ جادوگر نصب EAOS — سیستم عامل ایجنت — فوق ساده — پشتیبانی صفر — Zero Support
...
## 🎯 EAOS — سیستم عامل ایجنت چیه؟ به زبان ساده:

LLM local Ollama + ترید + صدا + pgvector embeddings RAG + confidence threshold
...
### 🤖 LLM Provider — برای ایجنت

**چیه؟** هوش مصنوعی برای ایجنت — گزینه: ollama لوکال رایگان، openai

**گزینه‌ها:**
- **ollama** — https://ollama.com/ — رایگان
- **openai** — https://platform.openai.com/api-keys
- **mock**

### 📱 SMS — برای ناتیف ترید

**چیه؟** وقتی ترید می‌شه پیامک می‌ده
...
## 🔔 سیستم ناتیفیکیشن — ایجنت + ترید + صدا — سقف 10/10
...
**کد:** `eaos/notification/service.py`
...
**پشتیبانی صفر:** همه راهنماها همون‌جا بود — اگر بازم گیر کردی: https://github.com/ansariaiadmin/eaos/issues
