...
echo.
echo ========================================
echo   eaos — Setup Wizard v3.1.0 — پشتیبانی صفر — تاریکی روشن شد — Windows
echo ========================================
echo.
echo سلام! 👋 جادوگر eaos — v3.1.0 — تاریکی روشن شد
echo.
...
:create_env
(
echo # eaos — .env — v3.1.0 — تاریکی روشن شد — %date% %time%
...
echo.
echo 🎉 جادو تمام! eaos آماده — تاریکی روشن شد! 🎉
