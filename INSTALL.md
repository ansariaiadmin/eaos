# راهنمای کامل EAOS — Enterprise Agent OS — برای افراد غیر فنی
...
- **تکنولوژی:** FastAPI + React Flow + Temporal
- **آدرس پیش‌فرض:** http://localhost:8000 (API) و http://localhost:3000 (Web)
- **نوع:** web
...
```
- ورود: بدون لاگین پیش‌فرض، توکن در .env
...
### ۱. داشبورد اصلی
- آدرس: http://localhost:8000 (API) و http://localhost:3000 (Web)
...
- ایشو باز کن: https://github.com/ansariaiadmin/eaos/issues

**برای افراد کاملا غیر فنی:** فقط `install.sh` را اجرا کن، بعد مرورگر را باز کن به http://localhost:8000 (API) و http://localhost:3000 (Web) — همین!
